defmodule ExMon.PokeApi.Client do
  ...
  defp handle_get({:ok, %Tesla.Env{status: 404, body: _body}}),
    do: {:error, :not_found, "Pokemon not found!"}

  defp handle_get({:error, reason}), do: {:error, :internal_server_error, reason}
end
